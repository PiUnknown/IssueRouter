          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/8 bg-black/40 py-2.5 pl-10 pr-4 text-sm text-slate-100 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30"
              />
            </div>
          </div>

          <div className="ml-6 flex items-center gap-4">
            <div className="hidden items-center gap-2 rounded-full border border-blue-400/20 bg-blue-500/10 px-4 py-2 md:flex">
              <Activity className="h-4 w-4 text-blue-300" />
              <span className="text-xs font-semibold tracking-[0.18em] text-blue-200">LIVE INGESTION</span>
            </div>
